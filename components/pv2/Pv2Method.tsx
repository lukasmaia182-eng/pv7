  ...
  return (
    <section className="relative min-h-[85vh] flex flex-col">
      ...
      <div className="relative z-10 mt-auto px-5 pb-12 max-w-lg mx-auto w-full text-center">
        ...
        <a
          href="#oferta"
          className="inline-flex items-center justify-center gap-2 bg-[#e8637a] hover:bg-[#d45269] text-white font-bold rounded-full px-8 py-4 text-lg transition-all shadow-lg w-full max-w-sm btn-pulse"
        >
