export function ScienceSection() {
  return (
    <section className="py-20 md:py-28 bg-[var(--color-dark)] relative overflow-hidden">
      {/* Subtle pattern */}
      ...
      <div className="relative max-w-4xl mx-auto px-4 sm:px-6">
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-14">
          ...
          <div className="space-y-5">
            <p className="text-[var(--color-dark-foreground)]/80 leading-relaxed text-lg">
            ...
            <div className="border-l-2 border-[var(--color-gold)] pl-5">
              <p className="font-heading text-2xl font-bold text-[var(--color-gold)] mb-1">
                Vínculo Traumático
              </p>
              <p className="text-[var(--color-dark-foreground)]/70 text-base leading-relaxed">
                Ele não mora no relacionamento. Mora no seu sistema nervoso.
              </p>
            </div>
            <p className="text-[var(--color-dark-foreground)]/80 leading-relaxed">
            ...
            <p className="text-[var(--color-dark-foreground)]/80 leading-relaxed">
              ...
              <strong className="text-[var(--color-dark-foreground)]">
          ...
          <div className="space-y-4">
            <p className="text-[var(--color-dark-foreground)]/60 text-sm uppercase tracking-wider mb-5">
            ...
            {[
              ...
              >
                <p className="text-[var(--color-dark-foreground)] font-medium text-sm leading-tight">
                  {item.title}
                </p>
                <p className="text-[var(--color-dark-foreground)]/50 text-sm mt-1">
                  {item.sub}
                </p>
              </div>
            ))}
        ...
        <div className="text-center max-w-2xl mx-auto">
          <p className="font-heading text-2xl sm:text-3xl md:text-4xl text-[var(--color-dark-foreground)] font-light italic leading-relaxed text-balance">
            Não é falta de amor próprio.<br />
            Não é fraqueza.<br />
            <span className="text-[var(--color-gold)] font-semibold not-italic">
              É biologia sendo usada contra você.
            </span>
          </p>
          <p className="text-[var(--color-dark-foreground)]/60 mt-4 text-base">
